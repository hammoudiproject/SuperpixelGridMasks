...
SuperpixelGridMasks is a data augmentation approach which permits to generate various complementary data from original sensor data (e.g. X-Ray scans, vehicular surveillance images, motion sensor images, multivariate images). This approach allows to increase the size of your image-based training datasets towards expecting better performances in your recognition tasks and developments of smart sensors. This work is currently under review. Once reviewed, source codes will be publicly made available online. 
